...
public class PetrinetNavigatorLabelProvider extends LabelProvider
	...
	*/
	private String getTransition_2001Text(View view) {
		IParser parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Transition_2001,
	...
	*/
	private String getPlace_2002Text(View view) {
		IParser parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Place_2002,
				view.getElement() != null ? view.getElement() : view,
