...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Selected Arc</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link yawlannotations.impl.SelectedArcImpl#isSelected <em>Selected</em>}</li>
 *   <li>{@link yawlannotations.impl.SelectedArcImpl#getSourceTransition <em>Source Transition</em>}</li>
 *   <li>{@link yawlannotations.impl.SelectedArcImpl#getTargetTransition <em>Target Transition</em>}</li>
 *   <li>{@link yawlannotations.impl.SelectedArcImpl#getSourceMarking <em>Source Marking</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectedArcImpl extends ObjectAnnotationImpl implements SelectedArc {
	/**
	...
	protected EClass eStaticClass() {
		return YawlannotationsPackage.Literals.SELECTED_ARC;
	}
	...
	public void setSelected(boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__SELECTED, oldSelected, selected));
	}
	...
	public EnabledTransition getSourceTransition() {
		if (sourceTransition != null && sourceTransition.eIsProxy()) {
			...
			if (sourceTransition != oldSourceTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YawlannotationsPackage.SELECTED_ARC__SOURCE_TRANSITION, oldSourceTransition, sourceTransition));
			}
		}
	...
	public NotificationChain basicSetSourceTransition(EnabledTransition newSourceTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__SOURCE_TRANSITION, oldSourceTransition, newSourceTransition);
	...
	public void setSourceTransition(EnabledTransition newSourceTransition) {
		if (newSourceTransition != sourceTransition) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__SOURCE_TRANSITION, newSourceTransition, newSourceTransition));
	}
	...
	public EnabledTransition getTargetTransition() {
		if (targetTransition != null && targetTransition.eIsProxy()) {
			...
			if (targetTransition != oldTargetTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YawlannotationsPackage.SELECTED_ARC__TARGET_TRANSITION, oldTargetTransition, targetTransition));
			}
		}
	...
	public NotificationChain basicSetTargetTransition(EnabledTransition newTargetTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__TARGET_TRANSITION, oldTargetTransition, newTargetTransition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetTransition(EnabledTransition newTargetTransition) {
		if (newTargetTransition != targetTransition) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__TARGET_TRANSITION, newTargetTransition, newTargetTransition));
	}
	...
	public Marking getSourceMarking() {
		if (sourceMarking != null && sourceMarking.eIsProxy()) {
			...
			if (sourceMarking != oldSourceMarking) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YawlannotationsPackage.SELECTED_ARC__SOURCE_MARKING, oldSourceMarking, sourceMarking));
			}
		}
	...
	public void setSourceMarking(Marking newSourceMarking) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawlannotationsPackage.SELECTED_ARC__SOURCE_MARKING, oldSourceMarking, sourceMarking));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YawlannotationsPackage.SELECTED_ARC__SOURCE_TRANSITION:
				if (sourceTransition != null)
					msgs = ((InternalEObject)sourceTransition).eInverseRemove(this, YawlannotationsPackage.ENABLED_TRANSITION__OUT_ARCS, EnabledTransition.class, msgs);
				return basicSetSourceTransition((EnabledTransition)otherEnd, msgs);
			case YawlannotationsPackage.SELECTED_ARC__TARGET_TRANSITION:
				if (targetTransition != null)
					msgs = ((InternalEObject)targetTransition).eInverseRemove(this, YawlannotationsPackage.ENABLED_TRANSITION__IN_ARCS, EnabledTransition.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YawlannotationsPackage.SELECTED_ARC__SELECTED:
				return isSelected();
			case YawlannotationsPackage.SELECTED_ARC__SOURCE_TRANSITION:
			...
			case YawlannotationsPackage.SELECTED_ARC__SOURCE_MARKING:
