...
import dk.dtu.compute.mbse.petrinet.diagram.edit.policies.PetrinetTextSelectionEditPolicy;
...
public class TransitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PetrinetTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Transition_2001, getParserElement(),
					PetrinetVisualIDRegistry
							.getType(dk.dtu.compute.mbse.petrinet.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, PetrinetEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
