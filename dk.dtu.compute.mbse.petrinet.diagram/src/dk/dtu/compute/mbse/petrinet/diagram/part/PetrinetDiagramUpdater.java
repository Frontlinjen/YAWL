...
public class PetrinetDiagramUpdater {
	...
	* @generated
	*/
	public static List<PetrinetNodeDescriptor> getPlace_2002SemanticChildren(View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
	...
	*/
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	*/
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2001IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2002IncomingLinks(View view) {
		Place modelElement = (Place) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
	...
	*/
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getTransition_2001OutgoingLinks(View view) {
		Transition modelElement = (Transition) view.getElement();
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<PetrinetLinkDescriptor> getPlace_2002OutgoingLinks(View view) {
		Place modelElement = (Place) view.getElement();
		LinkedList<PetrinetLinkDescriptor> result = new LinkedList<PetrinetLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Arc_4001(modelElement));
		return result;
