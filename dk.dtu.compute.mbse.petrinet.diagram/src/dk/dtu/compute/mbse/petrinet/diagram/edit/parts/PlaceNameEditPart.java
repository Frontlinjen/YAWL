...
public class PlaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Place_2002, getParserElement(),
					PetrinetVisualIDRegistry
							.getType(dk.dtu.compute.mbse.petrinet.diagram.edit.parts.PlaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
