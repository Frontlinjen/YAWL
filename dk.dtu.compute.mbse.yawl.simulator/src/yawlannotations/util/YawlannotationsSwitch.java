...
public class YawlannotationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case YawlannotationsPackage.SELECTED_ARC: {
				SelectedArc selectedArc = (SelectedArc)theEObject;
				T result = caseSelectedArc(selectedArc);
				if (result == null) result = caseObjectAnnotation(selectedArc);
				if (result == null) result = caseAnnotation(selectedArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Selected Arc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Selected Arc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectedArc(SelectedArc object) {
		return null;
	}
