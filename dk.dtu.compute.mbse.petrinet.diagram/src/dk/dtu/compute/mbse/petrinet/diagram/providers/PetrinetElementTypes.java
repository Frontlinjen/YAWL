...
public class PetrinetElementTypes {
	...
	* @generated
	*/
	public static final IElementType Petrinet_1000 = getElementType(
			"dk.dtu.compute.mbse.petrinet.diagram.Petrinet_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Transition_2001 = getElementType(
			"dk.dtu.compute.mbse.petrinet.diagram.Transition_2001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Place_2002 = getElementType("dk.dtu.compute.mbse.petrinet.diagram.Place_2002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Token_3001 = getElementType("dk.dtu.compute.mbse.petrinet.diagram.Token_3001"); //$NON-NLS-1$

	/**
	* @generated
	*/
	public static final IElementType Arc_4001 = getElementType("dk.dtu.compute.mbse.petrinet.diagram.Arc_4001"); //$NON-NLS-1$
	...
	*/
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Transition_2001, PetrinetPackage.eINSTANCE.getTransition());
