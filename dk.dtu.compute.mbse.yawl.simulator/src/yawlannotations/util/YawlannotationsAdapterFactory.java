...
public class YawlannotationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected YawlannotationsSwitch<Adapter> modelSwitch =
		new YawlannotationsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSelectedArc(SelectedArc object) {
				return createSelectedArcAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlannotations.EnabledTransition <em>Enabled Transition</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link yawlannotations.SelectedArc <em>Selected Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSelectedArcAdapter() {
		return null;
	}
